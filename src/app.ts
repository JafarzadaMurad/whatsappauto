...
import { referralRouter, adminReferralRouter } from './modules/referral/referral.routes';
import { liderUserRouter, liderPartnerRouter } from './modules/lider/lider.routes';
...
app.use('/api/lider', liderUserRouter);
// Server-to-server, authenticated by the shared partner key — never a
// browser session, which is why it is mounted apart from /api/lider.
app.use('/api/partner/lider', liderPartnerRouter);
